...
//            }
            ...
            Badge badge1 = new Badge("master del universo", "https://cdn.pixabay.com/photo/2017/07/11/15/51/kermit-2493979_1280.png");
            Badge badge2 = new Badge("becario enfurismado", "https://cdn.pixabay.com/photo/2017/07/11/15/51/kermit-2493979_1280.png");
            user.addBadges(badge1);
            user.addBadges(badge2);
    ...
    @GET
    @ApiOperation(value = "return badges of a user", notes = "badges")
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Successful", response=User.class),
    ...
    public Response getBadges(@PathParam("username") String username) {
        ...
        if (user == null) {
            ...
            List<Badge> list = user.getBadges();
